...
def TeamPlays(event=None):
    ...
    if team == "Placeholder":
        document.querySelector("#result").innerHTML = (
            "<br>Please select a team to find your players!" #you choose the placeholder and it tells you to choose an actual team
        )
        return

    team_players = {
        "Blue Bears": ["AKINGSON JAKE ANDES",  #these are the actual players of blue bears.
    ...
    document.querySelector("#result").innerHTML = (
        f"<b>Team:</b> <b>{team}</b><br><b>Players:</b><br> {players_html}" #this iterates every player in the blue bears team and displays it
